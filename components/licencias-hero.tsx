        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="space-y-6 pl-4">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-oxford-50 leading-tight">
                  {t("licencias.hero.title")} <br />
                  <span className="bg-gradient-to-r from-oxford-200 to-oxford-300 text-transparent bg-clip-text">
                    {t("licencias.hero.subtitle")}
                  </span>
                </h1>
                <p className="text-xl text-oxford-300 max-w-lg">
                  Gestión de licencias ambientales y permisos de conexión para plantas solares. Registro de generadoras
                  en la AMM con apoyo local en Guatemala, El Salvador y Honduras.
                </p>
                <div className="pt-4">
                  <Link
                    href="/contacto"
                  ...
                  >
                    ...
                    <div className="relative flex items-center justify-center space-x-2 text-solar-100 group-hover:text-white">
                      <span className="text-sm font-medium">{t("licencias.hero.cta")}</span>
          ...
          >
            <div className="relative aspect-[4/3] overflow-hidden rounded-2xl">
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-H1nMrPXW4SpIQzMIQXXfbdhRHTE6QA.png"
                alt="Gestión de Licencias"
                width={800}
                height={600}
