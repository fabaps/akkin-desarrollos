...
export function PreProyectosHero() {
  const { t } = useI18n()
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="space-y-6 pl-4">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-oxford-50 leading-tight">
                  {t("preProyectos.hero.title")} <br />
                  <span className="bg-gradient-to-r from-oxford-200 to-oxford-300 text-transparent bg-clip-text">
                    {t("preProyectos.hero.subtitle")}
                  </span>
                </h1>
                <div className="space-y-2">
                  <p className="text-xl text-oxford-300">{t("preProyectos.hero.description")}</p>
                  <ul className="space-y-2 text-lg text-oxford-300">
                    <li className="flex items-start gap-2">
                      ...
                      <span>{t("preProyectos.hero.item1")}</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="block w-1.5 h-1.5 rounded-full bg-solar-500 mt-2.5 flex-shrink-0" />
                      <span>{t("preProyectos.hero.item2")}</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="block w-1.5 h-1.5 rounded-full bg-solar-500 mt-2.5 flex-shrink-0" />
                      <span>{t("preProyectos.hero.item3")}</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="block w-1.5 h-1.5 rounded-full bg-solar-500 mt-2.5 flex-shrink-0" />
                      <span>{t("preProyectos.hero.item4")}</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="block w-1.5 h-1.5 rounded-full bg-solar-500 mt-2.5 flex-shrink-0" />
                      <span>{t("preProyectos.hero.item5")}</span>
                    </li>
                  </ul>
                </div>
                <div className="pt-4">
                  ...
                  >
                    ...
                    <div className="relative flex items-center justify-center space-x-2 text-solar-100 group-hover:text-white">
                      <span className="text-sm font-medium">{t("preProyectos.hero.cta")}</span>
          ...
          >
            <div className="relative aspect-[4/3] overflow-hidden rounded-2xl">
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-tWqbDF1JNtHZP9fb7ZjlEUuZhntxBK.png"
                alt="Diseño y Permisología"
                width={800}
                height={600}
